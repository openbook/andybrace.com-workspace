...
[Should I Bake](https://www.shouldibake.com) is a single page web app that aims to help users make a better informed choice about when they should bake depending on the amount of renewable energy that is being generated.  The eventual idea being to
